       ...
       <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
            ...
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="media margin-bottom-30">
                ...
                <div class="media-body">
                  <h2 class="media-heading text-uppercase blue-text">${adminedit.a_name }</h2>
                  <p>&nbsp;&nbsp;&nbsp;${adminedit.a_proview }</p>
                </div>        
              </div>
                  ...
                  <tbody>
                   <tr>
                    ...
                    <tr>
                      ...
                      <td>Tel.</td>
                      <td>${adminedit.a_tel }</td>                    
                    </tr> 
                    <tr>
                      <td><div class="circle pink-bg"></div></td>
                      <td>E-mail</td>
                      <td>${adminedit.a_email }</td>                    
                    </tr>  
          ...
          <c:if test="${loginadmin.a_proview == '经理' }"> 
            ...
            <form action="Adminupdate?admin.a_id=${adminedit.a_id }" class="templatemo-login-form" method="post" enctype="multipart/form-data" >
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputFirstName">用户名</label>
                    <input type="text" class="form-control" id="inputFirstName" name="admin.a_username" placeholder="${adminedit.a_username }"  >                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputLastName">真实姓名</label>
                    <input type="text" class="form-control" id="inputLastName" name="admin.a_name" placeholder="${adminedit.a_name }">                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputUsername">性别</label>
                    <input type="text" class="form-control" id="inputUsername" name="" placeholder="${adminedit.a_tel }">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputEmail">Tel</label>
                    <input type="text" class="form-control" id="inputEmail" name="admin.a_tel" placeholder="${adminedit.a_tel }">                  
                </div> 
              </div>
               <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputUsername">E-mail.</label>
                    <input type="email" class="form-control" id="inputEmail" name="admin.a_email" placeholder="${adminedit.a_email }">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputEmail">住址</label>
                    <input type="text" class="form-control" id="inputUsername" placeholder="${adminedit.a_tel }">                  
                </div> 
              </div>
             <c:if test="${adminedit.a_proview != '经理' }">
			   <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group"> 
